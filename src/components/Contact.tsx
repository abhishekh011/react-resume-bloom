      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8 animate-slide-in-left">
            <div>
              <h3 className="text-2xl font-semibold mb-6 transform hover:scale-105 transition-all duration-300 hover:text-blue-400">
                Let's Connect
              </h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 transform hover:scale-105 hover:bg-gray-800 transition-all duration-300 p-4 rounded-lg hover:shadow-lg">
                ...
                <div>
                  ...
                  <a
                    href="mailto:mouryamohitsingh@gmail.com"
                    className="text-gray-300 hover:text-white transition-colors"
                  >
                    abhishekhjadam787971@gmail.com
                  </a>
                </div>
              </div>
          ...
          <Card className="bg-gray-800 border-gray-700 transform hover:scale-105 hover:shadow-2xl transition-all duration-500 animate-slide-in-right hover-3d">
            <CardHeader>
              <CardTitle className="text-white transform hover:text-blue-400 transition-colors duration-300">
                Send a Message
              </CardTitle>
            </CardHeader>
