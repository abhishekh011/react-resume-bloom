      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in transform-3d-container">
          ...
          <div className="flex justify-center space-x-6">
            <a href="tel:+916260335083" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 hover:rotate-12 hover-3d">
              <Phone className="h-6 w-6" />
            </a>
            <a href="mailto:mouryamohitsingh@gmail.com" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 hover:-rotate-12 hover-3d">
              <Mail className="h-6 w-6" />
            </a>
            <a href="https://www.linkedin.com/in/mohit-rajput-mr13" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 hover:rotate-12 hover-3d">
              <Linkedin className="h-6 w-6" />
            </a>
            <a href="#" className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 transform hover:scale-110 hover:-rotate-12 hover-3d">
