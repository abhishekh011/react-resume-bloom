        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-slide-in-left">
              <h3 className="text-2xl font-semibold text-gray-800 transform hover:scale-105 transition-all duration-300">
                Summary
              </h3>
              <p className="text-gray-600 leading-relaxed transform hover:scale-105 transition-all duration-300 hover:text-gray-800">
                A highly qualified software developer with 1 year of
                professional experience at NewTech Fusion Pvt Ltd. Proficient in
                Core Java, JavaScript, and the MERN stack, with hands-on
                experience working on live projects such as Ready Doc, Medicity,
                and Interview-Byte.
              </p>
              <p className="text-gray-600 leading-relaxed transform hover:scale-105 transition-all duration-300 hover:text-gray-800">
                Quick learner with strong problem-solving skills, committed to
                continuous learning and contributing effectively to team
                success.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-6 transform hover:scale-105 hover:shadow-lg transition-all duration-300 hover:bg-blue-50 rounded-r-lg p-4">
                  ...
                  <p className="text-gray-600">
                    Barkatullah University | 7.90 CGPA
                  </p>
                ...
                <div className="border-l-4 border-purple-500 pl-6 transform hover:scale-105 hover:shadow-lg transition-all duration-300 hover:bg-purple-50 rounded-r-lg p-4">
                  ...
                  <p className="text-gray-600">Govt H.S.S NandaNager Indore</p>
